...
THRESHOLD_HEAP_FREE_BYTES_MIN_8266 = int(
    os.environ.get("THRESHOLD_HEAP_FREE_BYTES_MIN_8266", "35000")
)
...
# Optional public endpoint override for presigned OTA URLs (for devices outside Docker network).
...
OTA_UPLOAD_MAX_MB = int(os.environ.get("OTA_UPLOAD_MAX_MB", "32"))
DATA_UPLOAD_MAX_MEMORY_SIZE = OTA_UPLOAD_MAX_MB * 1024 * 1024
FILE_UPLOAD_MAX_MEMORY_SIZE = OTA_UPLOAD_MAX_MB * 1024 * 1024
